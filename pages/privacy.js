    ...
    <div>
      ...
      <Row className="justify-content-center">
        <Col md="7" className="text-center">
          <h2 className="title">Monovpn Privacy Policy</h2>
          <h6 className="subtitle">This document (“Privacy Policy”) explains the privacy rules applicable to personal data and other information collected or submitted when you access, install, 
          or use Monovpn Services and Websites regardless of the device (computer, mobile phone, tablet, etc.) you use.
          The data controller of your personal data, as described in this Privacy Policy, is MonoGroup Security Solutions(address : 11106 Blue Feather Dr, Houston, 77064, Texas, USA.
            email: privacy@monovpn.org, mob:+12513176911 ).
            </h6>
           <h6 className='subtitle'> The capitalized words used in this Privacy Policy as definitions are defined here or in our General Terms.</h6>
        <h6 className='subtitle'> By visiting our Websites, by submitting your personal data to us, and by accessing, installing and/or using 
            our Services, you confirm that you have read this Privacy Policy and agree to be bound by this Privacy Policy. If you do not agree with this Privacy Policy or any 
            provisions hereof, please do not use our Services and Websites.
          </h6>
          <h5 className='title'> 1.PROCESSING OF YOUR PERSONAL DATA</h5>
          <h6 className='subtitle'>Monogroup processes personal data to a limited scope to provide Services, process payments for the Services, 
          and enable the functioning of our Websites and mobile applications. We may process the following categories of personal data:</h6>
          <h6 className='title'>Information for creating your Account</h6>
          <h6 className='subtitle'> Email address. We ask for your email address as part of your registration. 
          It is necessary for the creation of your Monogroup Account, retrieving a lost password, and using the Services.
...
Payment data. This information is necessary to collect payments for the Services. Our payment processing partners process basic billing information for payment processing and refund requests (e.g., date of purchase, payers IP address, postal (ZIP) code, credit card owners full name and credit card information). We also process some of such billing information ourselves (e. g., date of purchase, credit card owners full name, part of your credit card number, its expiration date) in cases of recurring payments or when you provide your payment details directly to us.
...
Information for payment fraud prevention. To prevent fraudulent payments for the Services, your personal data (such as payers email address and device information) can be verified by our and/or our payment processing partners fraud management tools. A payment transaction that is considered high risk may be rejected by us.
Communication data
<br/>
Email address. We use your email address to: i) send you important updates and announcements related to your use of the Services and Websites; ii)<br/> respond to your requests or inquiries; iii) send you offers, surveys, and other marketing content (you can opt-out of those at any time).
...
Communication optimization data. We use various tools to help us optimize our emailing campaigns. These tools may track actions you perform with an email, such as open it or unsubscribe from further communication. We may also be able to see the user devices operating system (e.g., Windows, Mac, iOS, Android) and country in order to optimize push and email notifications and automatically set the language.
...
Live chat widget. If you contact us via live chat widget, in addition to processing your contact information, we will also process your device information (such as type of the operating system and browser) and IP address. This information is necessary for our support to determine the users country, prevent abuse,see if the user is connected to our servers, and help our support to process queries faster.
Information collected on our applications and Websites

Service usage. We collect information about specific Monogroup Services (monovpn, MonogroupPass, MonogroupLocker, etc.) and features you use.
...
Information for participating in referral programs. Participation in referral programs maintained by Monogroup requires referrers to submit personal data (e.g., full name, e-mail address, phone number, relationship with the referred party) about themselves and a referred party so that Monogroup could i) reach out to the referred party; ii) contact referrers with regards to their participation in referral programs and/or provision of rewards. It is the referrers responsibility to abide by applicable privacy laws when disclosing third parties’ personal data to Monogroup, including informing third parties that they are providing referred parties’ personal data to Monogroup and how it will be used and processed. Referred parties may unsubscribe from any future communication at any time. If you believe that one of your contacts has provided us with your personal data and you would like it to be removed from our database, please contact us.
...
Account data. For the purpose of managing and administering our profiles on social networks (e.g., “Facebook”, “Instagram”, “Twitter”, “LinkedIn”, “YouTube” accounts), we may collect and process your personal data (e.g., full name, social network profile name, pictures, and/or public comments) you provided voluntarily.
 ...
 <h5 className='title'>2. GROUNDS FOR PROCESSING OF PERSONAL DATA</h5>
...
Bundled subscriptions (Third Party Services purchased through Monogroup). By subscribing to the Bundled Subscription which includes Third Party Services purchased through Monogroup, you agree that certain purchase information (e.g., your email address, Subscription term, payment amount, and subscription ID) will be shared with the respective provider of Third Party Services for purposes of activating, administering, and provision of Third Party Services, also for improving your experience, and communicating with you about the Bundled Subscription and Third Party Services. When you use Third Party Services, your personal data is processed by the provider of Third Party Services (which acts as a separate data controller of your personal data) according to the procedures established by it and governed by its privacy policies.

Other Monogroup group companies. We share your personal data with other Monogroup group companies to carry out our daily business operations and to enable us to maintain and provide our Services to you. We may also share the contact information of Monogroup business customers (i.e., our customers which use our products as a tool for their business) with Monogroup group companies for marketing of their B2B products purposes (business users have a right to object to such transfer at any time).
...
Access: know and access personal data Monogroup has collected about you;

Rectify: rectify, correct, update, or complement inaccurate/incomplete personal data Monogroup has about you;
...
Rectification. If you’d like to edit your profile information (e.g., change your email address, add additional username), please contact our support team at support@monovpn.org.

Access/Deletion. If you wish to delete your Account or your personal data that we process, or request to provide you with a copy of your personal data, please contact us at privacy@monovpn.org.
...
Additionally, you may delete your Monogroup Account for different Monogroup products as described below. To initiate deletion, please follow these steps and our support team will follow up with your request shortly:

monovpn Account via monovpn app on iPhone: open the monovpn app and log into your Account, tap on the Profile icon, tap “Contact Us”, select “Request account deletion”, type in “Please delete my account”, and tap “SEND”.

monovpn Account via monovpn desktop app on Mac: open the monovpn app and log into your Account, click on “Help” and select “Email Support”; on our “Contact Us” form select “Request account deletion”, type in “Please delete my account”, and click “SEND”.

MonogroupPass Account via MonogroupPass app on mobile devices: open the MonogroupPass app and log in to your Account, click on “Menu” icon at the bottom right of the window, tap the “Delete Account” option, and confirm by pressing “Submit Delete Request”; you will receive an email from MonogroupAccount customer support to verify your identity and proceed with the Account Removal process.

MonogroupPass Account via MonogroupPass desktop application: open the MonogroupPass app and log in to your Account, click on “Settings”, click the “Delete Account” option, and confirm by pressing “Submit Delete Request”; then, you will receive an email from MonogroupAccount customer support to verify your identity and proceed with the Account Removal process.

MonogroupLocker Account via MonogroupLocker app: open the MonogroupLocker app and log in to your Account, click on “Settings” icon, tap the “Delete account”; you will be directed to a new page on your mobile browser, click “Submit a request” at the top right corner, type in a message saying that you wish to remove your Account and indicate the email address your Account is registered with.

Monogroups Obligations on Termination. Upon expiration or termination of your Account and/or Subscription, Monogroup will immediately cease processing information thats associated with you. However, please note that there might be cases when we retain information associated with you after expiration or termination of your Account and/or Subscription: (i) all Monogroup products databases are connected; after expiration or termination of your Account, basic information (such as your email address) would still be visible in our system in case you have another existing Account associated with a different Monogroup product (e.g., if we delete your MonogroupPass Account, your email address would still be visible in our system if you have a monovpn or MonogroupLocker Account). In order to delete all of your data, we would need to delete all of your Accounts associated with different Monogroup products (in order to do so, please contact our support team); (ii) Monogroup also may retain information associated with you (e.g., payments data) in order to fulfill its obligations as required by applicable laws, regulations, court orders, subpoenas, or other legal processes for archival purposes.

Opt-out. If you wish to unsubscribe from our communication, you can opt out at any time by clicking the “unsubscribe” link at the bottom of each email or contacting us at privacy@monovpn.org.

You can control the use of cookies at the individual browser level on your device. To disable cookies, follow your browsers instructions on how to block or clear cookies.

If you do not agree with the processing of your personal data by Monogroup, please do not use our Services and Websites. You can request us to discontinue processing your personal data, in which case your data will be processed only as much as it is necessary to effect the discontinuation of your use of the Services (e.g., final settlement or deleting all personal data based on your email address), or finalizing other Monogroup’s legal relationship with you (e.g., record keeping, accounting, processing refunds). Please note that we or our third-party service providers may be obliged to retain your certain personal data as required by law.
...
<h5 className='title'>5. DATA SECURITY</h5>
...
If we detect something suspicious, we will notify you immediately and guide you through steps to stay better protected. However, no company can guarantee the absolute security of internet communications as no technology is completely bulletproof. By using the Services and Websites, you expressly acknowledge that we cannot guarantee the 100% security of personal data provided to or received by us through the Services and that any information received from you through Websites or our Services is provided at your own responsibility. If you have any reason to believe that your interaction with us is no longer secure, please notify us at privacy@monovpn.org.

<h5 className='title'>6. DATA RETENTION AND DELETION</h5>

Monogroup will keep your personal data only as long as necessary to provide you with the Services, or for as long as we have another legitimate ground to do so, but not longer than permitted or required by law. Some of more specific data retention terms are provided below:

Customer billing information and payment details are kept by Monogroup for 10 years from the last payment transaction.

Monogroup will use your email for marketing communication for 1 year after the end of your Subscription or until you exercise your right to opt-out, whichever comes first.

When we no longer have a legal ground to keep your personal data, it will either be securely disposed of, or de-identified through appropriate anonymization means. Monogroup will destroy personal data recorded or stored in the form of electronic files using method(s) that would prevent the recovery of the data.
          </h6>
          <h5 className='title'>CONTACT US</h5>
<h6 className='subtitle'>
If you have questions, requests, concerns, or complaints about this Privacy Policy or our personal data processing practices, please contact us via privacy@monovpn.org</h6>
          <h3 className='title'>Changes to This Privacy Policy</h3>
          <h6 className='subtitle'>We may change our Privacy Policy from time to time, 
          with or without notice to you, consistent with applicable privacy laws and principles.
          Your continued use of the Services and/or access to the 
          Site constitutes your acceptance of our Privacy Policy.</h6>
        </Col>
      </Row>
    </Container></div>
