...
const C2aComponent = () => {
  return (
    <div>
      ...
      <div className="spacer feature42 bg-danger-gradiant" id="grab">
        <Container>
          <Row className="justify-content-center wrap-feature49-box">
            <Col lg="7" md="10" className="text-center">
              ...
              <a href="https://play.google.com/store/apps/details?id=org.mono.app&pcampaignid=web_share" className="m-b-20">
